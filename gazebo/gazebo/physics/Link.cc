...
{
  //std::cout<<"Link: into Load\n";

  Entity::Load(_sdf);
  //std::cout<<"Link: past Entity load\n";
  ...
  //std::cout << "before loading inertia" << std::endl;
  //std::cout << this->sdf->HasElement("inertial");
  if (!this->IsStatic())
  {
    //std::cout<<"    after IsStatic()\n";
    //this->inertial->Load(this->sdf->GetElement("inertial"));
    
  }
  //std::cout << "loaded inertia" << std::endl;
#ifdef HAVE_OPENAL
