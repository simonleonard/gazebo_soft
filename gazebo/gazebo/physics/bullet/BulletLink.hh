...
namespace gazebo
{
  namespace physics
  {
    ...
    class GZ_PHYSICS_VISIBLE BulletLink : public Link
    {
      ...
      /// \brief Constructor2: create softbody
      public: virtual void setSoftLink(btSoftBody* bsb);
      ...
      //added by hudson: gets the soft link
      public: void addSoftLinkToWorld(btSoftBody* psb);
      public: void initSoftBodyPhysics(btSoftBody* psb);
