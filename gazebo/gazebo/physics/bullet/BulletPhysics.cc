    ...
    : PhysicsEngine(_world)
{
  ...
  this->collisionConfig = new btSoftBodyRigidBodyCollisionConfiguration();
  ...
  this->dynamicsWorld = new btSoftRigidDynamicsWorld(this->dispatcher,
		  this->broadPhase, this->solver, this->collisionConfig,softSolver);
