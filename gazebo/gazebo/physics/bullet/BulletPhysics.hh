...
namespace gazebo
{
  namespace physics
  {
    ...
    class GZ_PHYSICS_VISIBLE BulletPhysics : public PhysicsEngine
    {
      ...
      //for softbodies (hudson)
      public: btSoftRigidDynamicsWorld *GetDynamicsWorld() const
        {return this->dynamicsWorld;}
      ...
      //added by hudson to give softbody access to the physics stuff
    public: btBroadphaseInterface* getBroadPhase(){return this->broadPhase;}
    public: btDefaultCollisionConfiguration* getCollisionConfig(){return this->collisionConfig;}
    public: btCollisionDispatcher* getDispatcher(){return this->dispatcher;}

 
      //change by hudson, above was giving errors so tried to just make them public
      ...
      //needed for softbody implementation (hudson)
      private:btSoftRigidDynamicsWorld *dynamicsWorld;
      private: common::Time lastUpdateTime;

      /// \brief The type of the solver.
      //private: std::string solverType; (hudson)
