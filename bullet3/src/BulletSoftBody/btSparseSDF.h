...
struct	btSparseSdf
{
	...
	{
	  //std::cout<<"btSparseSdf::Initialize() -- "<<"{cell size: "<<cells.size()<<"}   \n";
	...
	void					Reset()
	{
	  //std::cout<<"btSparseSdf::Reset() -- "<<"{cell size: "<<cells.size()<<"}   \n";
	...
	{
	  //std::cout<<"btSparseSdf::GarbageCollect() -- "<<"{cell size: "<<cells.size()<<"}   \n";
	...
	{
	  //std::cout<<"btSparseSdf::RemoveReferences() -- "<<"{cell size: "<<cells.size()<<"}   \n";
  ...
  {
    //std::cout << this << std::endl;
	  //std::cout<<"Evaluate begin: size = {"<<cells.size()<<"}\n";

    if( cells.size() <= 0 ){ 
      //std::cout << "initializing (again): " << std::endl; Initialize();
    }
		/* Lookup cell			*/ 
...
//				printf("numResets=%d\n",numResets);
		...
		//std::cout << "ix.i" << ix.i << " " << iy.i << " " << iz.i << std::endl;
	...
	{
	  //std::cout<<"btSparseSdf::BuildCell() -- "<<"{cell size: "<<cells.size()<<"}   \n";
	...
	static inline btScalar	DistanceToShape(const btVector3& x,
		const btCollisionShape* shape)
	{
	  //std::cout<<"btSparseSdf::BuildCell() \n";
	...
	{
	  //std::cout<<"btSparseSdf::Decompose() \n";
